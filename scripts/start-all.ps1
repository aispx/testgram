...
# $env:App__DcOptions__0__IpAddress=YOUR_SERVER_IP
...
# $env:App__DcOptions__1__IpAddress=YOUR_SERVER_IP
...
# $env:App__DcOptions__2__IpAddress=YOUR_SERVER_IP
...
# $env:App__DcOptions__3__IpAddress=YOUR_SERVER_IP
...
# $env:App__WebRtcConnections__0__Ip=YOUR_SERVER_IP
