...
# export App__DcOptions__0__IpAddress=YOUR_SERVER_IP
...
# export App__DcOptions__1__IpAddress=YOUR_SERVER_IP
...
# export App__DcOptions__2__IpAddress=YOUR_SERVER_IP
...
# export App__DcOptions__3__IpAddress=YOUR_SERVER_IP
...
# export App__WebRtcConnections__0__Ip=YOUR_SERVER_IP
