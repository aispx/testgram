...
public partial class ObjectIdConsts
{
    ...
    public static readonly FrozenDictionary<uint, string> CommandServerHandlers = new Dictionary<uint, string>
    {
      ...
      { 0x2d03522fu, "SendPaymentFormHandler"},
      ...
      { 0x55b41fd6, "RegisterPasskeyHandler"},
      { 0xea1f0c52, "GetPasskeysHandler"},
      { 0xf5b5563f, "DeletePasskeyHandler"},
      { 0x518ad0b7, "InitPasskeyLoginHandler"},
      { 0x9857ad07, "FinishPasskeyLoginHandler"},
    }.ToFrozenDictionary();
}