...
/// </remarks>
internal sealed class GetDefaultBackgroundEmojisHandler(IDefaultEmojiListAppService defaultEmojiListAppService)
    : RpcResultObjectHandler<MyTelegram.Schema.Account.RequestGetDefaultBackgroundEmojis, MyTelegram.Schema.IEmojiList>
{
    ...
    {
        return defaultEmojiListAppService.GetAsync(DefaultEmojiListKind.Background, obj.Hash);
    }
}
