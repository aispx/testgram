...
/// </remarks>
internal sealed class GetEmojiStickersHandler(IInstalledStickerSetListService listService)
    : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestGetEmojiStickers,
        MyTelegram.Schema.Messages.IAllStickers>
{
    ...
    {
        return listService.GetAsync(input, StickerSetType.CustomEmoji, obj.Hash);
    }
}
