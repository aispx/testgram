...
/// See <a href="https://corefork.telegram.org/method/messages.reorderPinnedForumTopics" />
///</summary>
internal sealed class ReorderPinnedForumTopicsHandler(
    IMongoDatabase mongoDatabase,
    IPeerHelper peerHelper,
    IChannelAdminRightsChecker channelAdminRightsChecker) : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestReorderPinnedForumTopics, MyTelegram.Schema.IUpdates>
{
    protected override async Task<MyTelegram.Schema.IUpdates> HandleCoreAsync(IRequestInput input,
        MyTelegram.Schema.Messages.RequestReorderPinnedForumTopics obj)
    {
        ...
        var updatePinnedTopics = new TUpdatePinnedForumTopics
        {
        ...
        return new TUpdates
        {
            Updates = new TVector<IUpdate> { updatePinnedTopics },
