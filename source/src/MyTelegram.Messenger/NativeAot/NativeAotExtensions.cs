...
public static class NativeAotExtensions
{
    ...
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(ILayeredService<IEncryptedChatConverter>))]
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(ILayeredService<IEncryptedFileConverter>))]
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(ILayeredService<IEncryptedMessageConverter>))]
    ...
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(LayeredService<IEncryptedChatConverter>))]
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(LayeredService<IEncryptedFileConverter>))]
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(LayeredService<IEncryptedMessageConverter>))]
