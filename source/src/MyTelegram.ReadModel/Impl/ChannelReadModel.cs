    ...
    IAmReadModelFor<ChannelAggregate, ChannelId, MonoforumEnabledEvent>
{
    ...
    public Task ApplyAsync(IReadModelContext context, IDomainEvent<ChannelAggregate, ChannelId, MonoforumEnabledEvent> domainEvent, CancellationToken cancellationToken)
    {
