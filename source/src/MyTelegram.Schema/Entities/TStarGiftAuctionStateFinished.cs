...
public sealed partial class TStarGiftAuctionStateFinished : IStarGiftAuctionState
{
    ...
    public void Serialize(IBufferWriter<byte> writer)
    {
        ...
        if (Flags.IsBitSet(0) && ListedCount.HasValue) { writer.Write(ListedCount.Value); }
        if (Flags.IsBitSet(1) && FragmentListedCount.HasValue) { writer.Write(FragmentListedCount.Value); }
        if (Flags.IsBitSet(1) && FragmentListedUrl != null) { writer.Write(FragmentListedUrl); }
    }
